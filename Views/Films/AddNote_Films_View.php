<?php
	class AddNote_Films_View extends Lightbox_Global_View {
		
		private $form;
		
		public function AddNote_Films_View($viewparams) {
...
?>			
				<form action="./index.php?controller=Films&action=addNote&id=<?php echo $this->film->getId(); ?>" method="post" >
